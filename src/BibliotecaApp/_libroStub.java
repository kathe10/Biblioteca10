...
/**
* BibliotecaApp/_libroStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from biblioteca.idl
* domingo 19 de mayo de 2019 12:28:32 AM COT
*/

public class _libroStub extends org.omg.CORBA.portable.ObjectImpl implements BibliotecaApp.libro
{
  ...
  public boolean insertarLibro (String titulo, int autor, int categoria, int editorial, int paginas, String descripcion, String portada)
  {
            ...
            try {
                ...
                $out.write_long (autor);
                $out.write_long (categoria);
                $out.write_long (editorial);
                $out.write_long (paginas);
  ...
  public String consultarLibro (int asin)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("consultarLibro", true);
                $out.write_long (asin);
                $in = _invoke ($out);
  ...
  public String listarLibro ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("listarLibro", true);
                $in = _invoke ($out);
                String $result = $in.read_wstring ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
