...
/**
* BibliotecaApp/_lectorStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from biblioteca.idl
* domingo 19 de mayo de 2019 12:28:32 AM COT
*/

public class _lectorStub extends org.omg.CORBA.portable.ObjectImpl implements BibliotecaApp.lector
{
  ...
  public boolean insertarLector (String nombre, int celular, String observacion)
  {
            ...
            try {
                ...
                return insertarLector (nombre, celular, observacion        );
            } finally {
                _releaseReply ($in);
            }
  } // insertarLector
  ...
  public String consultarLector (int dnilector)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("consultarLector", true);
                ...
                return consultarLector (dnilector        );
            } finally {
                _releaseReply ($in);
            }
  } // consultarLector
  ...
  public boolean eliminarLector (int dnilector)
  {
            ...
            try {
                ...
                return eliminarLector (dnilector        );
            } finally {
                _releaseReply ($in);
            }
  } // eliminarLector
  ...
  public String listarLector ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("listarLector", true);
                $in = _invoke ($out);
                String $result = $in.read_wstring ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
